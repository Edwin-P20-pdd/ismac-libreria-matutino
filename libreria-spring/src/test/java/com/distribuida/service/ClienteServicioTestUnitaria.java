...
public class ClienteServicioTestUnitaria {
    ...
    public void setUp(){
        ...
        cliente.setCedula("1782469710");
        cliente.setNombre("Juan");
        cliente.setApellido("Aguilar");
        cliente.setDireccion("Av. Casa");
        cliente.setTelefono("0987543159");
        cliente.setCorreo("juan@ejemplo.com");
    }
    ...
    public void testUpdateExistente(){
        ...
        clienteActualizado.setCedula("1728496731");
        clienteActualizado.setNombre("Juan2");
        clienteActualizado.setApellido("Aguilar2");
        clienteActualizado.setDireccion("Av. casa2");
        clienteActualizado.setTelefono("0915648611");
        clienteActualizado.setCorreo("juan2@ejemplo.com");
